...
Save the DB
V03: aggiungo la fuznione per creare il plot complessivo
"""
import numpy as np
import matplotlib.pyplot as plt
import Cfr_Te_LIB_V02 as mye
import Cfr_Te_PLOTS_V02 as graph
import Cfr_Te_Overall_PLOT_V03 as overall
import time
import json
import pickle
# %reset
...
pippo = fig,ax = plt.subplots(1, num = 'Overall ECE vs HRTS')
...
for shot in shots:
    ...
    ovearll.fig_overall(d, vars, pippo, shots)
    ######################
