...
def res_an(d,vars):
    ...
    sig1 = vars['sig1']  # Segnali misurati dal canale 4 dell'HRTS
    fit1 = vars['fit1']  # Valori Fit del canale 4 HRTS
    sig2 = vars['sig2']   # Segnali misurati dal canale 4 dell'HRTS
    fit2 = vars['fit2']   # Valori Fit del canale 4 HRTS
    sig3 = vars['sig3']   # Segnali misurati dal canale 4 dell'HRTS
    fit3 = vars['fit3']   # Valori Fit del canale 4 HRTS
    sig4 = vars['sig4']   # Segnali miurati dal canale 4 dell'HRTS
    fit4 = vars['fit4']   # Valori Fit del canale 4 HRTS
    csqr = vars['csqr']   # Fit ChiSquare 
    ...
    fig, ax = plt.subplots(num='2 -Res vs Pos')
    ...
    plt.scatter(csqr.t, csqr.v[idx_pos,:], marker = 'o', s= 3, label='Chi^2')
    plt.axhline(y = 1, ls='--', lw = 0.8)
