...
idt = (f2.t >= tlim1-delta) & (f2.t <= tlim2+delta)
timeF2 = f2.t[idt]
f2 = f2.v[0,idt]

# ter,Ter = w.KK3.prfl.get(r=rad) # time  and Ece Rad (KK3) el. temp.
# idt = (ter >= tlim1-delta) & (ter <= tlim2+delta) 
# TimeER = ter[idt]
# TempER = Ter[idt]/1000
