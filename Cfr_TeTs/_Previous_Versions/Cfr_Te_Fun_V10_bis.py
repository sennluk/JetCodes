...
- E' possibile scegliere se inserire manualmente o calcolare in automaticoi range di psi e rho utilizzati per le medie,
  acommentando la dunzione def_range (per il calcolo in automatico), si utilizzazo i valori di inzializzazione  
- Aggiungo multiplot
...
d = {
    ...
    'intPsi' : 0.1,    # intervallo in Psi e Rhosu cui mediare 
