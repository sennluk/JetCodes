...
V06 - due plot: 
    1 -Andamenti delle temperature nel tempo. Ts con errore, Tece no. + Andamento rapporto nel tempo
    2 - Andamento di Tts(con errore) VS Tece
...
ErroY = Errots.v[0,:]/1000 # Divido per due perchè la barra è doppia, /1000 per keV
